...
public class BuiltinApplet extends PApplet {
   ...
   * Wrapper functions
   * 
   * float is not implemented in R, so processing.r need to cast double to float.
   */
  ...
  public void rect(double posAX, double posAY, double posBX, double posBY, double tl, double tr,
      double br, double bl) {
    super.rect((float) posAX, (float) posAY, (float) posBX, (float) posBY, (float) tl, (float) tr,
        (float) br, (float) bl);
  }
  ...
  public void bezier(double posAX, double posAY, double posAZ, double posBX, double posBY,
      double posBZ, double posCX, double posCY, double posCZ, double posDX, double posDY,
      double posDZ) {
    super.bezier((float) posAX, (float) posAY, (float) posAZ, (float) posBX, (float) posBY,
        (float) posBZ, (float) posCX, (float) posCY, (float) posCZ, (float) posDX, (float) posDY,
        (float) posDZ);
  }
  ...
  public double bezierPoint(double posAX, double posAY, double posBX, double posBY, double t) {
    return super.bezierPoint((float) posAX, (float) posAY, (float) posBX, (float) posBY, (float) t);
  }
  ...
  public double curvePoint(double posAX, double posAY, double posBX, double posBY, double t) {
    return super.curvePoint((float) posAX, (float) posAY, (float) posBX, (float) posBY, (float) t);
  }

  public double curveTangent(double posAX, double posAY, double posBX, double posBY, double t) {
    return super
        .curveTangent((float) posAX, (float) posAY, (float) posBX, (float) posBY, (float) t);
  }
