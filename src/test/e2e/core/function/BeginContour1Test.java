...
public class BeginContour1Test extends E2eTestBase {

  public BeginContour1Test() {
    coreCodeTemplate = "# beginContour 1 https://processing.org/reference/beginContour_.html\n\nsize(100, 100)\ntranslate(50, 50)\nstroke(255, 0, 0)\nbeginShape()\n# Exterior part of shape, clockwise winding\nvertex(-40, -40)\nvertex(40, -40)\nvertex(40, 40)\nvertex(-40, 40)\n# Interior part of shape, counter-clockwise winding\nbeginContour()\nvertex(-20, -20)\nvertex(-20, 20)\nvertex(20, 20)\nvertex(20, -20)\nendContour()\nendShape(CLOSE)\n\nsaveFrame(\"%s\")\nexit()\n";
